...
namespace Game1 {
    internal class Animator {
        protected Dictionary<string, FrameReference> SpriteSet { get; set; }
        protected FrameReference ActiveAnimation { get; set; }
        ...
        /// </summary>
        public Animator(Dictionary<string, FrameReference> spriteSet, string defaultAnimation) {
        ...
        /// </summary>
        /// <param name="spriteSet">The set of <see cref="FrameReference"/>s this object will hold.</param>
        /// <param name="defaultAnimation">The name of the default animation in <paramref name="spriteSet"/>.</param>
        public void LoadInit(Dictionary<string, FrameReference> spriteSet, string defaultAnimation) {
            SpriteSet = spriteSet;
